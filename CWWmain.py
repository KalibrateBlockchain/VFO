...
if mean_noise>max_noise:
  trapped_event='sample is too noisy'
  sys.exit()
...
if len(period)<numberOfPeriods:
  trapped_event="sample can't be analyzed"
  sys.exit()
...
if mode_of_processing==2:
  plt.savefig("-plot.png", bbox_inches='tight',pad_inches = 0, transparent=True, edgecolor='none')
